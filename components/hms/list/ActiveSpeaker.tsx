...
const ActiveSpeaker = () => {
    ...
    const isLocalVideoEnabled = useHMSStore(
        selectIsPeerVideoEnabled(activeSpeaker.id)
    )
    const isLocalAudioEnabled = useHMSStore(
        selectIsPeerAudioEnabled(activeSpeaker.id)
    )
    useEffect(() => {
